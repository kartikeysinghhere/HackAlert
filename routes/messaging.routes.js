...
const { authenticate, messageLimiter } = require('../middleware/security');
...
router.post('/:partner_email', authenticate, messageLimiter, validate(dmSchema), profanity.middleware, messagingController.sendMessage);
